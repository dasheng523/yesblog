...
nix --accept-flake-config run github:juspay/omnix -- \
  init github:srid/yesblog -o ./yourproject
```
...
Full instructions: https://srid.ca/yesblog/start
...
- Run the application without installing: `nix run github:srid/yesblog` (or `nix run .` from checkout)
- Common workflows
  - Adding library dependencies in Nix: https://community.flake.parts/haskell-flake/dependency
  - Adding tests: https://srid.ca/yesblog/tests

## Discussions

Questions? Ideas? Suggestions? Join our [NixOS Zulip](https://nixos.zulipchat.com/#narrow/stream/413949-haskell-flake) or post in [Github Discussions](https://github.com/srid/yesblog/discussions).
